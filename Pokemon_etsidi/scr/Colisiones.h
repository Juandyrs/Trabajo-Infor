...
public:
	...
	static bool colision(Vector2D rect, Vector2D pos, Vector2D dir, Vector2D origen, int a); // Colision entre una hitbox rectangular y una recta conociendo la direccion y el origen de la recta
};
